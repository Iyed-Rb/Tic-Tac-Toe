    ...
    public partial class Form2 : Form
    {
        ...
        private void Update(PictureBox pb)
        {
            ...
            else
            {
                ...
                if (Fail == 2)
                {
                    MessageBox.Show("No attempt left, You Lose!", "End Game", MessageBoxButtons.OK, MessageBoxIcon.Information,
                    MessageBoxDefaultButton.Button1);
                    GameStatus.Winner = enWinner.PC;
                    EndGame();
                ...
                {
                    MessageBox.Show("Wrong Choice, 1 attempt remaining", "Wrong", MessageBoxButtons.OK, MessageBoxIcon.Warning,
                        MessageBoxDefaultButton.Button1);
        ...
        private async void ComputerChoice()
        {
            ...
            while (!IsEmpty(randomNumber));

            switch (randomNumber)
            {
                case 1: Update(pb1); break;
                case 2: Update(pb2); break;
                case 3: Update(pb3); break;
                case 4: Update(pb4); break;
                case 5: Update(pb5); break;
                case 6: Update(pb6); break;
                case 7: Update(pb7); break;
                case 8: Update(pb8); break;
                case 9: Update(pb9); break;
            }
        }
        ...
        private bool IsEmpty(int number)
        {
            switch (number)
            {
                case 1: return pb1.Tag.ToString() == "?";
                case 2: return pb2.Tag.ToString() == "?";
                case 3: return pb3.Tag.ToString() == "?";
                case 4: return pb4.Tag.ToString() == "?";
                case 5: return pb5.Tag.ToString() == "?";
                case 6: return pb6.Tag.ToString() == "?";
                case 7: return pb7.Tag.ToString() == "?";
                case 8: return pb8.Tag.ToString() == "?";
                case 9: return pb9.Tag.ToString() == "?";
        ...
        //{
        //    Counter--;
        //    lbTime.Text = "Time: " + Counter.ToString();
        ...
        //        lbWinner.Text = "       PC";
        //        lbTurn.Text = "Game Over";
        //        lbTime.Text = "Game Over";
        //        MessageBox.Show("Time's up! PC wins!", "Game Over", MessageBoxButtons.OK, MessageBoxIcon.Information);
        //        DisableAllpb(); // Call a function to reset the game
        //    }
        //}
